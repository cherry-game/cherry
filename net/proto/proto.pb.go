...
const file_proto_proto_rawDesc = "" +
	...
	"\x05close\x18\x04 \x01(\bR\x05close\"q\n" +
	"\x13PomeloBroadcastPush\x12\x18\n" +
	"\auidList\x18\x01 \x03(\x03R\auidList\x12\x16\n" +
	"\x06allUID\x18\x02 \x01(\bR\x06allUID\x12\x14\n" +
	"\x05route\x18\x03 \x01(\tR\x05route\x12\x12\n" +
	"\x04data\x18\x04 \x01(\fR\x04dataB;Z9github.com/cherry-game/cherry/net/proto/proto;cherryProtob\x06proto3"
